...
<tbody>
<?php 
$queryResult = $pdo->query("SELECT * FROM fundacion");
while($fundacion = $queryResult-> fetch(PDO::FETCH_ASSOC)){ ?>
    <tr scope="row">
    <td><?php echo $fundacion['id_fundacion'] ?></td>
    <td><?php echo $fundacion['Nombre'] ?></td>
    <td><?php echo $fundacion['Telefono'] ?></td>
    <td><?php echo $fundacion['Ubicacion'] ?></td>

    <td>
    <?php echo '<a class="btn btn-primary" href="editarF.php?id_fundacion=' . $fundacion['id_fundacion'] . '" role="button"> Editar<a/> ' ?>
       <?php echo '<a class="btn btn-danger" href="eliminarF.php?id_fundacion=' . $fundacion['id_fundacion'] . '" role="button"> Eliminar<a/> ' ?>
</td>
</tr>
<?php } ; ?>
