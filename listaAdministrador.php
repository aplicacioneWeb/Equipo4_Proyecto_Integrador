...
<tbody>
<?php 
$queryResult = $pdo->query("SELECT * FROM administrador");
while($administrador = $queryResult->fetch(PDO::FETCH_ASSOC)){ ?>

    <tr scope="row">
    <td><?php echo $administrador['id_administrador'] ?></td>
    <td><?php echo $administrador['nombre'] ?></td>
    <td><?php echo $administrador['correo'] ?></td>
    <td><?php echo $administrador['colonia'] ?></td>
    <td><?php echo $administrador['RFC'] ?></td>
    <td><?php echo $administrador['edad'] ?></td>
    <td><?php echo $administrador['Sexo'] ?></td>
    <td><?php echo $administrador['Iniciar'] ?></td>

<td>
    <?php echo '<a class="btn btn-primary" href="editarA.php?id_administrador=' . $administrador['id_administrador'] . '" role="button"> Editar<a/> ' ?>
       <?php echo '<a class="btn btn-danger" href="eliminarAdministrador.php?id_administrador=' . $administrador['id_administrador'] . '" role="button"> Eliminar<a/> ' ?>
</td>
