...
<meta name=”author” content="AIXA SERAPIO HERNANDEZ"/>
...
<title>Lista de Donadores</title>
...
<body style="background-color:#FDFEFE;">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <li class="nav-item">
          ...
          <ul class="dropdown-menu">
            <li><a href="FormularioBeneficiado.html" class="dropdown-item">Registrr Beneficiado</a></li>
      ...
      <!--Tabla De Donadores-->
          ...
          <thead class="thead-dark">
            ...
            <th class="col">Clave</th>
              ...
              <th class="col">Aplledio Paterno</th>
...
<tbody>
<?php 
$queryResult = $pdo->query("SELECT * FROM donador");
while($donador = $queryResult-> fetch(PDO::FETCH_ASSOC)){ ?>
    <tr scope="row">
    <td><?php echo $donador['id_donador'] ?></td>
    <td><?php echo $donador['Nombre'] ?></td>
    <td><?php echo $donador['Paterno'] ?></td>
    <td><?php echo $donador['Materno'] ?></td>
    <td><?php echo $donador['Colonia'] ?></td>
    <td><?php echo $donador['Sexo'] ?></td>
    <td><?php echo $donador['Edad'] ?></td>

    <td>
    <?php echo '<a class="btn btn-primary" href="editarD.php?id_donador=' . $donador['id_donador'] . '" role="button"> Editar<a/> ' ?>
       <?php echo '<a class="btn btn-danger" href="eliminarDonador.php?id_donador=' . $donador['id_donador'] . '" role="button"> Eliminar<a/> ' ?>
</td>
</tr>
<?php } ; ?>
